$(document).ready(function(){
	...
	var allocate = $('.container').children('.row').eq(0);	// Allocate grid division
	var select = $('.container').children('.row').eq(1);		// the selected employes table division
	var response = $('.container').children('.row').eq(2);	//the response from the servlet
	/*Cursor effect*/
