...
<!-- Page Content -->
		...
		<!-- /.row -->
			...
			<div class="row" style="display: none">
				...
				<center><div id="chart1" style="height: 300px; width: 500px; position: relative;"class="jqplot-target"></div></center>
					<div class="panel panel-default">
			...
			<div class="row" style="display: none" align="right">
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						<center><div class="panel-heading" style=" border: 5px solid black;margin-bottom: 25px;width: 887px;">
